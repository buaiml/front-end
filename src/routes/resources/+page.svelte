	...
	const resources: ResourceItem[] = [
			...
			categories: [
				{
					...
					links: [
						...
						{
							name: 'Python Intro',
							url: 'https://colab.research.google.com/drive/1osQazDmdVf8HsCACOQUma6EORo07o1g2?usp=sharing'
						}
					]
				},
				{
					...
					links: [
						{
							...
							url: 'https://docs.google.com/presentation/d/1B_oRw8HvR425OCjllCO_4hMacEQ5hDab/edit?usp=sharing&ouid=111860343331968100995&rtpof=true&sd=true'
						},
						{
							name: 'Intro',
							url: 'https://docs.google.com/presentation/d/1wE2ZoodhhC7ZxuyP0UScniav-FyDJh_6LF0bM9JRT8k/edit?usp=sharing'
						},
						{
							name: 'What is a Neural Network',
							url: 'https://docs.google.com/presentation/d/1QGXX61Jr8A0m2FFiI2a-wpRMn70O48kHPPbhJahOd2o/edit?usp=sharing'
						},
						{
							name: 'Neural Networks from scratch',
							url: 'https://docs.google.com/document/d/1s5TtpFIGqU_u_wgWib9xjhd3ADWbwFkgSea9VECi3ho/edit?usp=sharing'
						},
						{
							name: 'Evolving Neural Networks',
							url: 'https://docs.google.com/presentation/d/1arAxYO94sDOkMPFPvT4vOa1dbRLVayqN4zd0PQdlMzo/edit?usp=sharing'
						},
						{
							name: 'Protecting Innovation through Speciation',
							url: 'https://docs.google.com/presentation/d/1cxRkXM4oOSXEYvgEBHb5jNmEeWQrDRzk-YAF0h3wkAc/edit?usp=sharing'
						},
						{
							name: 'Playing Snake',
							url: 'https://docs.google.com/presentation/d/1vibLcTLtCu8Ml3NqWPbrN4wxcFE5YWt5--Po3FpwHvQ/edit?usp=sharing'
						},
						{
							name: 'Intro to Computer Vision',
							url: 'https://docs.google.com/presentation/d/1rC_EwIXJAsFOlKQZmJvSklpDdSqR-tCQ/edit?usp=share_link&ouid=111860343331968100995&rtpof=true&sd=true'
						}
					]
				},
				{
				...
				},
				{
					...
					links: [
						{
							name: 'Intro to Perceptrons and ANNs',
							url: 'https://drive.google.com/file/d/1U6OzVB8xJDy5o6pMaQAjrsFuQbQFvLcZ/view?usp=sharing'
						},
				...
				{
					title: 'Paper Reading',
					links: [{ name: 'Augmenting Topologiea', url: 'https://nn.cs.utexas.edu/downloads/papers/stanley.ec02.pdf' }]
				},
				{
		...
		},
		{
			...
			categories: [
				{
					title: 'Code',
					links: [{ name: 'Pacathon Repository', url: 'https://github.com/nn/basics' }]
				},
				{
					title: 'Videos',
					links: [
...
<div class="mx-auto flex w-full max-w-3xl flex-col gap-8 px-4 pt-28 pb-16 sm:px-6">
	<h1 class="text-3xl font-semibold text-foreground">Resources</h1>

	{#each resources as resource (resource.title)}
		<div class="rounded-lg border border-border bg-card p-6 shadow-sm">
			<h2 class="mb-4 text-2xl font-semibold text-foreground">{resource.title}</h2>
			{#each resource.categories as category (category.title)}
				<div class="mb-4 last:mb-0">
					<h3 class="mb-1 text-lg font-semibold text-foreground">{category.title}</h3>
						...
						{#each category.links as link (link.url)}
							<li>
								<a
									...
									class="text-[#b22222] underline-offset-4 hover:underline"
								>
									{link.name}
								</a>
							</li>
